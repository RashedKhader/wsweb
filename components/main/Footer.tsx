            ...
            <div className="w-full flex flex-col items-center justify-center m-auto">
                <div className="w-full h-full flex flex-row items-center justify-around flex-wrap z-20">
                    ...
                    <div className="min-w-[200px] h-auto flex flex-col items-center justify-start">
                        ...
                        <p className="flex flex-row items-center my-[15px] cursor-pointer" onClick={() => window.open("https://www.instagram.com/wahaspace/")} >
                            <FaInstagram />
                    ...
                    <div className="min-w-[200px] h-auto flex flex-col items-center justify-start">
                        ...
                        <p className="flex flex-row items-center my-[15px] cursor-pointer">
                            ...
                            <span className="text-[15px] ml-[6px]">wahaspace@gmail.com</span>
                        </p>
                    </div>
                </div>
